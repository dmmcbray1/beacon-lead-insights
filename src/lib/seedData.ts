...
export function getSeedKPIs(): KPIData {
  return {
    ...
    totalSold: 35,
    totalCallbacks: 187,
    totalCallbacksQuoted: 80,
    totalNoContact: 155,
    totalStalePipeline: 63,
    badPhoneCount: 73,
    totalVoicemailLeads: 252,
    totalVoicemailCallbacks: 53,
    totalNonVoicemailCallbacks: 134,
    voicemailLeadRate: 0.202,
    voicemailCallbackToQuoteRate: 0.29,
    nonVoicemailCallbackToQuoteRate: 0.26,
    contactRate: 0.514,
    quoteRate: 0.175,
    quotedToSoldRate: 0.161,
    contactToQuoteRate: 0.340,
    callbackToQuoteRate: 0.289,
    noContactRate: 0.33,
    avgCallsToQuote: 4.3,
    avgDaysToQuote: 6.8,
    avgDaysContactToQuote: 2.9,
    singleTouchQuotePct: 0.19,
